...
public interface DivPageDAO {
	 ...
	 * @return 返回POJO对象
	 */
	public <T> T nextOne(Class<T> clazz, String field, String value,int orderType) throws DAOException;
	 ...
	 * @return 返回POJO对象
	 */
	public <T> T preOne(Class<T> clazz, String field, String value,int orderType) throws DAOException;
